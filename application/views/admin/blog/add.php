<div class="p-0 container-fluid">
    ...
    <span class="mb-3">Create a New Blog Post on your Website</span>
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="mb-3 row">
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo_if('is-invalid', form_error('title')); ?>" type="text" name="title" id="title" value="<?php echo $this->input->post('title'); ?>" placeholder="Enter Post Title"/>
                        </div>
                    </div>
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo_if('is-invalid', form_error('permalink')); ?>" type="text" name="permalink" id="permalink" value="<?php echo $this->input->post('permalink'); ?>" placeholder="Enter Post Permalink"/>
                        </div>
                    </div>
                </div>
                <div class="mb-3">
                    <div class="form-group">
                        ...
                        <textarea rows="3" class="form-control <?php echo_if('is-invalid', form_error('post_description')); ?>" name="post_description" id="post_description" placeholder="Enter SEO Post Description"><?php echo $this->input->post('post_description'); ?></textarea>
                    </div>
                </div>
                <div class="mb-3">
                    <div class="form-group">
                    <label class="form-label <?php echo_if('text-danger', form_error('post_keywords')); ?>" for="post_keywords">SEO Post Tags <span class="text-danger">*</span></label>
                        <input class="form-control <?php echo_if('is-invalid', form_error('post_keywords')); ?>" type="text" name="post_keywords" id="post_keywords" value="<?php echo $this->input->post('post_keywords'); ?>" placeholder="Enter Post Tags Comma Separated"/>
                    </div>
                </div>
                <div class="mb-3">
                    <div class="form-group">
                ...
                <div class="mb-3">
                    <div class="form-group">
                        ...
                        <textarea rows="10" class="form-control <?php echo_if('is-invalid', form_error('body')); ?>" name="body" id="body" placeholder="Enter the Post Content"><?php echo $this->input->post('body'); ?></textarea>
