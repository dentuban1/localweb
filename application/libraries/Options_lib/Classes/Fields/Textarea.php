    ...
    public function render() {
        ...
        ?>
            <div class="py-2 form-group">
                ...
                <textarea rows="4" class="<?php echo join( ' ', $this->dom['classes'] ); ?>" id="<?php echo $this->dom['id']; ?>" name="key-<?php echo $this->key; ?>" placeholder="<?php echo $this->dom['placeholder']; ?>" <?php echo join(' ', $attrs); ?>><?php echo $this->value() ?></textarea>
    ...
    public function repeater_render() {
        ...
        ?>
            <div class="py-2 form-group">
                ...
                <textarea x-model="data.items[index]['<?php echo $this->key ?>']" rows="4" x-bind:class="(data.errors && data.errors['<?php echo $this->key ?>-' + index]) && 'is-invalid'" :value="item['<?php echo $this->key ?>'] ? item['<?php echo $this->key ?>'] : data.fields['<?php echo $this->key ?>'].default" class="<?php echo join( ' ', $this->dom['classes'] ); ?>" :id="'<?php echo $this->dom['id']; ?>' + '-' + index" type="text" :name="'key-<?php echo $this->repeater['key'] ?>[' + index + '][<?php echo $this->key ?>]'" placeholder="<?php echo $this->dom['placeholder']; ?>" <?php echo join(' ', $attrs); ?>></textarea>
                <small class="text-muted"><?php echo $this->field['description'] ?></small>
            </div>
        <?php
    }
